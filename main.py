...
def attack(char_name: str, char_class: str) -> str:
    """В зависимости от класса результаты применения атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимости от класса результаты применения защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """В зависимости от класса резултаты применения спец. умения. """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        char_class = input('Введи название персонажа, которым хочешь играть:'
